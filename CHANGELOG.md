...
- rename CHANGELOG.md to HISTORY.md to make way for GCG [\#19](https://github.com/OpenVoxProject/openbolt/pull/19) ([jessereynolds](https://github.com/jessereynolds))
